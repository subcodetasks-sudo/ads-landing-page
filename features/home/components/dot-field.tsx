...
const DotField = memo(function DotField({
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      const targetGlowOpacity = eng > 0.01 ? Math.min(0.35 + eng * 0.5, 0.85) : 0;
      glowOpacity.current += (targetGlowOpacity - glowOpacity.current) * 0.08;
      ...
      >
        <defs>
          <radialGradient id={glowIdRef.current}>
            ...
            <stop offset="55%" stopColor={glowColor} stopOpacity="0.4" />
